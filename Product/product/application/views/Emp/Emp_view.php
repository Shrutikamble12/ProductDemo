...
<link rel="stylesheet" href="<?=base_url();?>Assets/select2/multiselect.css" />
    ...
    <div class="input-group">
        <input type="number" name="mobileNo" id="mobileNo" class="form-control" onKeyPress="if(this.value.length==10) return false;" value="<?php if(!empty($data)) echo $data[0]->mobileNo ; ?>">
        <div class="input-group-append">
            <button class="btn btn-info" type="button" id="navId" name="navId">
