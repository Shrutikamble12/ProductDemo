    ...
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function(b) {
            ...
            if (d += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>", b.free) {
             ...
             return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'><span class='que_img'><img src='"+b.image+"'></span ><div class='que_data'>" + b.title + (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") + "</div></a>", d += "<div class='action'><span class='que_more'><img src='WebAssets/assets/images/svg/more.svg'></span><span class='que_close'><img src='WebAssets/assets/images/svg/close.svg'></span></div></div>"+b.option+"</li>"
        },
