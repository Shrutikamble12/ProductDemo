    ...
    color: orange;
    font-weight: 900;"> <a href="#">Comtranse Technology Kolhapur</a></p> -->
   ...
   <script src="<?=base_url();?>Assets/js/plugins/bootstrap.bundle.min.js" async></script>
   <!--<script src="<?=base_url();?>path/to/js/bootstrap.bundle.min.js"></script>-->
